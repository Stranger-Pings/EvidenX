...
speaker_0: "thank you your information will help us investigating further"`
  ...
  return (
    <div className="flex flex-col bg-background ">
      <div className="flex-1 border-b border-muted-foreground/10 p-6 pt-8 flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden gap-6 p-6 pb-4">
        {/* Audio Player */}
            ...
            >
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2 h-36 overflow-y-auto scrollbar-w-1 scroll-m-1">
        ...
        {/* Transcript Panel */}
        <div className="w-96 border bg-card flex flex-col overflow-y-auto rounded-lg mr-4">
