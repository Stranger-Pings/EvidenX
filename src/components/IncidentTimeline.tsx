    ...
    const filteredEvents = useMemo(() => {
        return caseData.events.filter((event) => {
            ...
            if (selectedView === "timeline") {
                if (selectedDate) {
                    // Show specific day
                    if (event.date.day !== selectedDate.day || event.date.month !== selectedDate.month)
                        return false;
                } else {
                    // Show all incidents for current month
                    if (event.date.month !== currentMonth)
                        return false;
                }
            }
            return true;
                                        ...
                                        return (
                                            <>
                                                <button
                                                    ...
                                                    disabled={isFirst}
                                                    className={`px-3 py-1.5 rounded-lg text-sm font-medium ${isFirst
                                                ...
                                                <button
                                                    ...
                                                    disabled={isLast}
                                                    className={`px-3 py-1.5 rounded-lg text-sm font-medium ${isLast
                                                        ? "bg-slate-200 text-slate-400 cursor-not-allowed"
                                                        : "bg-blue-700 text-white hover:bg-blue-800"
                                                        }`}
                                                >
            ...
            <div className="overflow-auto flex-1 max-h-[calc(100vh-16rem)]">
                 ...
                 {selectedDate && (
                     <div className="sticky top-0 bg-white pb-4 mb-4 flex">
                         ...
                         <div className="relative h-12 bg-slate-50 border-t border-r border-b border-slate-300 rounded-r-lg flex-1">
                             {Array.from(
                                 {
                                     length: Math.ceil(dataTimeRange.end - dataTimeRange.start) + 1,
                                 },
                ...
                <div className="space-y-1">
                    {caseData.actors.map((actor) => (
                        <div
                            key={actor.id}
                            className={`relative flex ${actor.type === "victim"
                        ...
                        >
                            ...
                            <div
                                className={`flex-1 relative h-24 rounded-lg border ${actor.type === "victim"
                                    ? "bg-amber-50 border-amber-200"
                                ...
                                {filteredEvents
                                    ...
                                    .map((event) => (
                                        <div
                                            ...
                                            className={`absolute rounded px-2 py-1 cursor-pointer hover:scale-105 transition-all  border-2 ${selectedEvent?.id === event.id
                                            ...
                                            style={{
                                                left: `${((event.time - dataTimeRange.start) /
                                                    (dataTimeRange.end - dataTimeRange.start)) *
                                                    100 +
                                                    1
                                                    }%`,
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200">
                ...
                <div className="p-4">
                    ...
                    <div className="grid grid-cols-7 gap-1">
                        {days.map((day, index) => (
                            <div key={index} className="h-20 border border-slate-200 p-1 hover:bg-slate-50">
                                {day && (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 h-[calc(100vh-8rem)]">
                    ...
                    <div className="bg-white rounded-lg p-6 h-full flex flex-col shadow-sm border border-slate-200">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-slate-600 mb-4">{caseData.timeframe}</p>
                ...
                >
                  ...
                  Month View
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-2 px-3 py-2 border rounded-lg font-medium text-sm ${selectedView === "timeline"
                                        ? "bg-blue-700 text-white border-blue-700"
                                        : "bg-white text-slate-700 border-slate-200 hover:bg-slate-50"
                                        }`}
                                >
                            ...
                            <div className="mt-6 pt-4 border-t">
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium">
                                            {filteredEvents.filter((e) => e.type === "witness").length}
                                        </span>
                                    </div>
                                </div>
                            </div>
