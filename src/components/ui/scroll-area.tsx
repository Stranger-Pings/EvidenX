...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        "flex touch-none p-px transition-colors select-none hover:bg-muted/50 bg-muted/20",
        orientation === "vertical" &&
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className="bg-muted-foreground/60 relative flex-1 rounded-full hover:bg-muted-foreground/80 transition-colors"
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  );
}
